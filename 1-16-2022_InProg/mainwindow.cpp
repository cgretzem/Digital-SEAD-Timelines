...
void MainWindow::on_AddMarkingRangeButton_clicked()
{
    ...
    if(isInt(input_8) && isInt(input_8)){ //verify that the value to be inputted is an int
    ...
    switch(ui->fireTypeSelector->currentIndex()){
        ...
        case 0: case 1:{
            ...
            if(!errorOccured){
                ...
                if(currentGun == &gun1){ ui->TimelineDisplayGun1->setText(ui->TimelineDisplayGun1->toPlainText() + x); }
                else if (currentGun == &gun2){ ui->TimelineDisplayGun2->setText(ui->TimelineDisplayGun2->toPlainText() + x); }
                else if (currentGun == &gun3){ ui->TimelineDisplayGun3->setText(ui->TimelineDisplayGun3->toPlainText() + x); }
                else if (currentGun == &gun4){ ui->TimelineDisplayGun4->setText(ui->TimelineDisplayGun4->toPlainText() + x); }
                else if (currentGun == &gun5){ ui->TimelineDisplayGun5->setText(ui->TimelineDisplayGun5->toPlainText() + x); }
                else { ui->TimelineDisplayGun6->setText(ui->TimelineDisplayGun6->toPlainText() + x); }
