...
void NonStandard_Timeline::addMarkingRound(markingType mType, int markingTOT)
{
   ...
   // Sexagesimal marking = Sexagesimal(startTime, timeOnTarget, 0) + Sexagesimal(0,0, markingTOF - 5 - markingTOT);
    ...
    Sexagesimal marking = Sexagesimal(startTime, timeOnTarget, 0) - Sexagesimal(0,0, markingTOF + 5) + Sexagesimal(0,markingTOT,0); //Sexagesimal(0,0,fireFreq); //-80

    //Sexagesimal marking = Sexagesimal(startTime, markingTOT, 0) + Sexagesimal(0,0, markingTOF - 5 - markingTOT);
