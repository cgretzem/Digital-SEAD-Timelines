    ...
    switch(ui->fireTypeSelector->currentIndex()){
        ...
        case 0: case 1:{
            ...
            if(!errorOccured){
                ...
                if(currentGun == &gun1){
                    ...
                    //tLineArry[0] = ui->TimelineDisplayGun1->toPlainText().toStdString();


                    if(tt == CONTINUOUS){
                        printInput[0].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[0].tLineType = "Interrupted";
                    }else{
                        printInput[0].tLineType = "NEGATIVE";
                    }

                    printInput[0].casTOT = ui->input_1->text().toStdString();

                    printInput[0].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[0].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[0].mType = "ILLUM";
                    }else{
                        printInput[0].mType = "NEGATIVE";
                    }

                    printInput[0].mTOF = ui->input_5->text().toStdString();

                    printInput[0].tLineNum = "              Gun 1 Timeline ";
                    printInput[0].tLineNum += printInput[0].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[0] += x.toStdString();
                    ...
                    //tLineArry[1] = ui->TimelineDisplayGun2->toPlainText().toStdString();

                    if(tt == CONTINUOUS){
                        printInput[1].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[1].tLineType = "Interrupted";
                    }else{
                        printInput[1].tLineType = "NEGATIVE";
                    }

                    printInput[1].casTOT = ui->input_1->text().toStdString();

                    printInput[1].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[1].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[1].mType = "ILLUM";
                    }else{
                        printInput[1].mType = "NEGATIVE";
                    }

                    printInput[1].mTOF = ui->input_5->text().toStdString();

                    printInput[1].tLineNum = "              Gun 2 Timeline ";
                    printInput[1].tLineNum += printInput[1].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[1] += x.toStdString();
                    ...
                    //tLineArry[2] = ui->TimelineDisplayGun3->toPlainText().toStdString();

                    if(tt == CONTINUOUS){
                        printInput[2].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[2].tLineType = "Interrupted";
                    }else{
                        printInput[2].tLineType = "NEGATIVE";
                    }

                    printInput[2].casTOT = ui->input_1->text().toStdString();

                    printInput[2].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[2].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[2].mType = "ILLUM";
                    }else{
                        printInput[2].mType = "NEGATIVE";
                    }

                    printInput[2].mTOF = ui->input_5->text().toStdString();

                    printInput[2].tLineNum = "              Gun 3 Timeline ";
                    printInput[2].tLineNum += printInput[2].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[2] += x.toStdString();
                    ...
                    //tLineArry[3] = ui->TimelineDisplayGun4->toPlainText().toStdString();

                    if(tt == CONTINUOUS){
                        printInput[3].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[3].tLineType = "Interrupted";
                    }else{
                        printInput[3].tLineType = "NEGATIVE";
                    }

                    printInput[3].casTOT = ui->input_1->text().toStdString();

                    printInput[3].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[3].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[3].mType = "ILLUM";
                    }else{
                        printInput[3].mType = "NEGATIVE";
                    }

                    printInput[3].mTOF = ui->input_5->text().toStdString();

                    printInput[3].tLineNum = "              Gun 4 Timeline ";
                    printInput[3].tLineNum += printInput[3].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[3] += x.toStdString();
                    ...
                    tLineArry[4] = ui->TimelineDisplayGun5->toPlainText().toStdString();

                    if(tt == CONTINUOUS){
                        printInput[4].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[4].tLineType = "Interrupted";
                    }else{
                        printInput[4].tLineType = "NEGATIVE";
                    }

                    printInput[4].casTOT = ui->input_1->text().toStdString();

                    printInput[4].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[4].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[4].mType = "ILLUM";
                    }else{
                        printInput[4].mType = "NEGATIVE";
                    }

                    printInput[4].mTOF = ui->input_5->text().toStdString();

                    printInput[4].tLineNum = "              Gun 5 Timeline ";
                    printInput[4].tLineNum += printInput[4].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[4] += x.toStdString();
                    ...
                    //tLineArry[5] = ui->TimelineDisplayGun6->toPlainText().toStdString();

                    if(tt == CONTINUOUS){
                        printInput[5].tLineType = "Continuous";
                    }else if(tt == INTERRUPTED){
                        printInput[5].tLineType = "Interrupted";
                    }else{
                        printInput[5].tLineType = "NEGATIVE";
                    }

                    printInput[5].casTOT = ui->input_1->text().toStdString();

                    printInput[5].supTOF = ui->input_2->text().toStdString();

                    if(mt == WP){
                        printInput[5].mType = "WP";
                    }else if(mt == ILLUM){
                        printInput[5].mType = "ILLUM";
                    }else{
                        printInput[5].mType = "NEGATIVE";
                    }

                    printInput[5].mTOF = ui->input_5->text().toStdString();

                    printInput[5].tLineNum = "              Gun 6 Timeline ";
                    printInput[5].tLineNum += printInput[5].tLineType;
                    //tLineArry[0] += "\n\n";
                    tLineArry[5] += x.toStdString();
        ...
        case 2:
            ...
            if(!invalidChar(input_1)){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText(ui->errorWindow->toPlainText() + "ERROR: TOT has invalid characters\n");
            }
            ...
            if(!invalidChar(input_2)){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText(ui->errorWindow->toPlainText() + "ERROR: TOF has invalid characters\n");
            }
            ...
            if(!invalidChar(input_3)){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText(ui->errorWindow->toPlainText() + "ERROR: Fire Frequency has invalid characters\n");
            }
            ...
            if(!invalidChar(input_5) && ui->MarkingSelector->currentIndex() > 0){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText(ui->errorWindow->toPlainText() + "ERROR: Marking TOF has invalid characters\n");
            }
            ...
            if(!errorOccured){
                ...
                if(currentGun == &gun1){
                    ...
                    printInput[0].tLineType = "Non-Standard";

                    printInput[0].casTOT = ui->input_1->text().toStdString();

                    printInput[0].supTOF = ui->input_2->text().toStdString();

                    printInput[0].supFF = ui->input_3->text().toStdString();

                    printInput[0].supFR = "";
                    for(fireRange i : frVec){
                        printInput[0].supFR += to_string(i.startMin);
                        printInput[0].supFR += ",";
                        printInput[0].supFR += to_string(i.endMin);
                        printInput[0].supFR += "  ";

                    }

                    printInput[0].mAt = "";
                    for(int i : frVecMark){ printInput[0].mAt += to_string(i); printInput[0].mAt += " "; }
                    ...
                    printInput[1].tLineType = "Non-Standard";

                    printInput[1].casTOT = ui->input_1->text().toStdString();

                    printInput[1].supTOF = ui->input_2->text().toStdString();

                    printInput[1].supFF = ui->input_3->text().toStdString();

                    printInput[1].supFR = "";
                    for(fireRange i : frVec){
                        printInput[1].supFR += to_string(i.startMin);
                        printInput[1].supFR += ",";
                        printInput[1].supFR += to_string(i.endMin);
                        printInput[1].supFR += "  ";

                    }

                    printInput[1].mAt = "";
                    for(int i : frVecMark){ printInput[1].mAt += to_string(i); printInput[1].mAt += " "; }
                    ...
                    printInput[2].tLineType = "Non-Standard";

                    printInput[2].casTOT = ui->input_1->text().toStdString();

                    printInput[2].supTOF = ui->input_2->text().toStdString();

                    printInput[2].supFF = ui->input_3->text().toStdString();

                    printInput[2].supFR = "";
                    for(fireRange i : frVec){
                        printInput[2].supFR += to_string(i.startMin);
                        printInput[2].supFR += ",";
                        printInput[2].supFR += to_string(i.endMin);
                        printInput[2].supFR += "  ";

                    }

                    printInput[2].mAt = "";
                    for(int i : frVecMark){ printInput[2].mAt += to_string(i); printInput[2].mAt += " "; }
                    ...
                    printInput[3].tLineType = "Non-Standard";

                    printInput[3].casTOT = ui->input_1->text().toStdString();

                    printInput[3].supTOF = ui->input_2->text().toStdString();

                    printInput[3].supFF = ui->input_3->text().toStdString();

                    printInput[3].supFR = "";
                    for(fireRange i : frVec){
                        printInput[3].supFR += to_string(i.startMin);
                        printInput[3].supFR += ",";
                        printInput[3].supFR += to_string(i.endMin);
                        printInput[3].supFR += "  ";

                    }

                    printInput[3].mAt = "";
                    for(int i : frVecMark){ printInput[3].mAt += to_string(i); printInput[3].mAt += " "; }
                    ...
                    printInput[4].tLineType = "Non-Standard";

                    printInput[4].casTOT = ui->input_1->text().toStdString();

                    printInput[4].supTOF = ui->input_2->text().toStdString();

                    printInput[4].supFF = ui->input_3->text().toStdString();

                    printInput[4].supFR = "";
                    for(fireRange i : frVec){
                        printInput[4].supFR += to_string(i.startMin);
                        printInput[4].supFR += ",";
                        printInput[4].supFR += to_string(i.endMin);
                        printInput[4].supFR += "  ";

                    }

                    printInput[4].mAt = "";
                    for(int i : frVecMark){ printInput[4].mAt += to_string(i); printInput[4].mAt += " "; }
                    ...
                    printInput[5].tLineType = "Non-Standard";

                    printInput[5].casTOT = ui->input_1->text().toStdString();

                    printInput[5].supTOF = ui->input_2->text().toStdString();

                    printInput[5].supFF = ui->input_3->text().toStdString();

                    printInput[5].supFR = "";
                    for(fireRange i : frVec){
                        printInput[5].supFR += to_string(i.startMin);
                        printInput[5].supFR += ",";
                        printInput[5].supFR += to_string(i.endMin);
                        printInput[5].supFR += "  ";

                    }

                    printInput[5].mAt = "";
                    for(int i : frVecMark){ printInput[5].mAt += to_string(i); printInput[5].mAt += " "; }
...
void MainWindow::on_clearButtonGuns_clicked(){
    ...
    for(int i = 0; i < 6; i++){ tLineArry[i] = "NA"; clearPrintInputs(i); }
