    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->input_1->setText("0");
    ui->input_2->setText("0");
    ui->input_3->hide();
    ui->input_5->hide();
    ui->input_6->hide();
    ui->input_7->hide();
    ...
    switch(index){
       ...
       //first clear all relevant input fields if they need to be cleared
        ...
        case 2:
            ...
            ui->input_6->show();
            ui->input_6->setText("0");
            ui->input_7->show();
            ui->input_7->setText("0");
    ...
    switch(ui->fireTypeSelector->currentIndex()){
        ...
        case 2:
            ...
            if(frVec.empty()){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText("Add Supress Range\n");
            }
            if(frVecMark.empty() && ui->MarkingSelector->currentIndex() != 0){
                errorOccured = true;
                ui->errorWindow->show();
                ui->errorWindow->setText("Add Marking Range\n");
            }
            if(!errorOccured){
                ui->errorWindow->setTextColor(Qt::black);   //errors have been printed, set text color back to black
                ui->errorWindow->clear();
